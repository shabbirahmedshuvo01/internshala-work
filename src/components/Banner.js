...
const Banner = () => {
    return (
        <div className='mx-20 mt-10'>
            <div>
                <p className='font-semibold text-xl'>In this 5 day class we will explore artists Monet, Matisse, Van Gogh, among others and then recreate paintings using crayon and watercolor. Students will have fun learning about the artists & creating their own art inspired by their work.</p>
            </div>
            ...
            <div className='mt-6 pl-5 flex'>
                ...
                <button className='pl-5 text-indigo-600 text-xl'> <span><i class="fa fa-gratipay"></i></span> Save</button>
                <button className='pl-5 text-indigo-600 text-xl'> <span><i class="fa fa-share"></i></span> Share</button>
